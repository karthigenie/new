 ...
 */
  ...
  function handleSocialSignup(e) {
   ...
   /*  setTimeout(()=>{
    ...
    axios
      .post("http://18.136.104.1:5001/auth/login", {
        username: login,
        password: password,
      })
      .then((response) =>
  ...
  function handleSocialSignup(e) {
    ...
    axios
      .post("http://18.136.104.1:5001/auth/register", {
        username: login,
        password: password,
        name: name,
        email: email,
  ...
  return (
    ...
    >
      <div className="css">
        ...
        <h2>
          iGenie is one stop platform for Non <br /> Destructive Testing
        </h2>
      </div>
      <div
          ...
          <div>
            ...
            <div className="">
              <form
                id="form"
                className="form"
                onSubmit={(e) => handleSocialSignup(e)}
              >
                <div className="FormControl">
                  <label htmlFor="email">Username</label>
                  <input
